...
<x-app-layout>
    <div class="container mx-auto lg:w-2/3 p-5">
        <h1 class="text-3xl font-bold mb-2">History Peminjaman</h1>
        <div class="bg-white rounded-lg p-3 overflow-x-auto">
            <table class="table-auto w-full">
                <thead>
                <tr class="border-b-2">
                    <th class="text-left p-2">Peminjaman #</th>
                    <th class="text-left p-2">Date</th>
                    <th class="text-left p-2">Status</th>
                    <th class="text-left p-2">Jaminan</th>
                ...
                @foreach($orders as $order)
                    <tr class="border-b">
                        ...
                        <td class="py-1 px-2">Rp. {{$order->total_price}}</td>
