...
class CheckoutController extends Controller
{
    public function checkout(Request $request)
    {
        ...
        // \Stripe\Stripe::setApiKey('sk_test_51NKgUbFxrJmzfJ74H7d58Xg24JyymGAo3gcjkdGUnIyHcskGBrWdDZ8RGJabhswwnIO6vXy6wKZvbz8CgkGqlr6j00u8MROBth');
...
//                        'images' => [$product->image]
        ...
        return view('checkout.success', ['message' => ""]);
    }
