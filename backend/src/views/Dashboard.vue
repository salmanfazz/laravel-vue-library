<template>
  ...
  <div class="grid grid-cols-1 md:grid-cols-4 gap-3 mb-4">
    ...
    >
      <label class="text-lg font-semibold block mb-2">Total Member</label>
    ...
    >
      <label class="text-lg font-semibold block mb-2">Total Buku</label>
    ...
    >
      <label class="text-lg font-semibold block mb-2">Total Peminjaman</label>
    ...
    >
      <label class="text-lg font-semibold block mb-2">Total Denda</label>
  ...
  >
    ...
    >
      <label class="text-lg font-semibold block mb-2">Latest Peminjaman</label>
    ...
    <div class="bg-white py-6 px-5 rounded-lg shadow">
      <label class="text-lg font-semibold block mb-2">Latest Member</label>
